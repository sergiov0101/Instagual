...
public class A11ModeladoPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "A11Modelado";
	...
	private A11ModeladoPersistentManager() throws PersistentException {
	...
	public Configuration createConfiguration() {
		...
		configuration.addAnnotatedClass(orm_instagual.Usuario.class);
		configuration.addAnnotatedClass(orm_instagual.Publicacion.class);
		configuration.addAnnotatedClass(orm_instagual.Multimedia.class);
		configuration.addAnnotatedClass(orm_instagual.Comentario.class);
		configuration.addAnnotatedClass(orm_instagual.Etiqueta.class);
		configuration.addAnnotatedClass(orm_instagual.Configuracion.class);
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new A11ModeladoPersistentManager();
		}
